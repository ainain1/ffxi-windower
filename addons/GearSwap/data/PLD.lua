...
function init_gear_sets()
    ...
    sets.precast.Waltz = {ammo="Sonia's Plectrum",
        head="Reverence Coronet +1",
        body="Gorney Haubert +1",hands="Reverence Gauntlets",ring2="Asklepian Ring",
    ...
    sets.precast.WS = {ammo="Ginsen",
        ...
        body="Gorney Haubert +1",hands="Cizin Mufflers +1",ring1="Rajas Ring",ring2="Cho'j Band",
    ...
    sets.precast.WS['Sanguine Blade'] = {ammo="Ginsen",
        ...
        body="Reverence Surcoat +1",hands="Reverence Gauntlets",ring1="Shiva Ring",ring2="K'ayres Ring",
    ...
    sets.precast.WS['Atonement'] = {ammo="Iron Gobbet",
        ...
        back="Fierabras's Mantle",waist=gear.ElementalBelt,legs="Ogier's Breeches",feet="Caballarius Leggings"}
    ...
    sets.idle = {ammo="Iron Gobbet",
        ...
        body="Caballarius Surcoat +1",hands="Reverence Gauntlets",ring1="Sheltered Ring",ring2="Defending Ring",
    ...
    sets.idle.Weak = {ammo="Iron Gobbet",
        ...
        back="Fierabras's Mantle",waist="Nierenschutz",legs="Crimson Cuisses",feet="Reverence Leggings +1"}
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        ...
        body="Caballarius Surcoat +1",hands="Cizin Mufflers +1",ring1="Defending Ring",ring2="Dark Ring",
    ...
    sets.defense.HP = {ammo="Iron Gobbet",
        ...
        body="Reverence Surcoat +1",hands="Reverence Gauntlets",ring1="Defending Ring",ring2="Meridian Ring",
        back="Weard Mantle",waist="Creed Baudrier",legs="Reverence Breeches +1",feet="Reverence Leggings +1"}
    sets.defense.Reraise = {ammo="Iron Gobbet",
        head="Twilight Helm",neck="Twilight Torque",ear1="Creed Earring",ear2="Bloodgem Earring",
        body="Twilight Mail",hands="Cizin Mufflers +1",ring1="Defending Ring",ring2=gear.DarkRing.physical,
    ...
    sets.defense.Charm = {ammo="Iron Gobbet",
        ...
        body="Caballarius Surcoat +1",hands="Cizin Mufflers +1",ring1="Defending Ring",ring2=gear.DarkRing.physical,
        back="Shadow Mantle",waist="Nierenschutz",legs="Caballarius Breeches +1",feet="Reverence Leggings +1"}
    -- To cap MDT with Shell IV (52/256), need 76/256 in gear.
    -- Shellra V can provide 75/256, which would need another 53/256 in gear.
    sets.defense.MDT = {ammo="Demonry Stone",
        head="Reverence Coronet +1",neck="Twilight Torque",ear1="Creed Earring",ear2="Bloodgem Earring",
        body="Caballarius Surcoat +1",hands="Reverence Gauntlets",ring1="Defending Ring",ring2="Shadow Ring",
        back="Mubvumbamiri mantle",waist="Creed Baudrier",legs="Caballarius Breeches +1",feet="Reverence Leggings +1"}
