...
function job_buff_change(buff, gain)
	...
	if buff == "Impetus" then
		if (buff == "Impetus" and gain) or buffactive['Impetus'] then
            send_command('text set Impetus fg 50 53 151 255 bg 0 0 0 192 show showbg position 800 250 font Arial 18 bold 1 text "Impetus"')
        else
            send_command('text set Impetus hide')
        end
	end
	
	if buff == "Berserk" then
		if (buff == "Berserk" and gain) or buffactive['Berserk'] then
            send_command('text set Berserk fg 255 53 51 255 bg 0 0 0 192 show showbg position 800 450 font Arial 18 bold 1 text "Berserk"')
        else
            send_command('text set Berserk hide')
        end
	end
	
	if buff == "Counterstance" then
		if (buff == "Counterstance" and gain) or buffactive['Counterstance'] then
            send_command('text set Counterstance fg 10 153 51 255 bg 0 0 0 192 show showbg position 800 650 font Arial 18 bold 1 text "Counterstance"')
        else
            send_command('text set Counterstance hide')
        end
	end
	...
	if buff == "Sleep" then
		if (buff == "Sleep" and gain) or buffactive['Sleep'] then
            send_command('text set Debuff fg 204 153 51 255 bg 0 0 0 192 show showbg position 600 250 font Arial 32 bold 1 text "Sleep"')
        else
            send_command('text set Debuff hide')
        end
	end
	
	if buff == "Paralyze" then
		if (buff == "Paralyze" and gain) or buffactive['Paralyze'] then
            send_command('text set Debuff fg 204 153 51 255 bg 0 0 0 192 show showbg position 600 250 font Arial 32 bold 1 text "Paralyze"')
        else
            send_command('text set Debuff hide')
        end
	end
	...
	if buff == "Slow" then
		if (buff == "Slow" and gain) or buffactive['Slow'] then
            send_command('text set Debuff fg 204 153 51 255 bg 0 0 0 192 show showbg position 600 250 font Arial 32 bold 1 text "Slow"')
        else
            send_command('text set Debuff hide')
        end
	end
