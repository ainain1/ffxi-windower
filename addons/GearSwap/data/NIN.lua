...
function user_setup()
    ...
    gear.MovementFeet = {name="Ninja Kyahan"}
    gear.DayFeet = "Ninja Kyahan"
...
function init_gear_sets()
    ...
    sets.defense.Evasion = {
        head="Felistris Mask",neck="Ej Necklace",
        body="Otronif Harness +1",hands="Otronif Gloves +1",ring1="Defending Ring",ring2="Beeline Ring",
    ...
    sets.engaged.Acc = {ammo="Qirmiz Tathlum",
        ...
        body="Mochizuki Chainmail",hands="Otronif Gloves +1",ring1="Rajas Ring",ring2="Epona's Ring",
    ...
    sets.engaged.Acc.Evasion = {ammo="Qirmiz Tathlum",
        ...
        body="Otronif Harness +1",hands="Otronif Gloves +1",ring1="Beeline Ring",ring2="Epona's Ring",
    ...
    sets.engaged.PDT = {ammo="Qirmiz Tathlum",
        ...
        body="Otronif Harness +1",hands="Otronif Gloves +1",ring1="Defending Ring",ring2="Epona's Ring",
        back="Yokaze Mantle",waist="Patentia Sash",legs="Hachiya Hakama",feet="Otronif Boots +1"}
