...
function init_gear_sets()
	...
	sets.precast.WS['Cataclysm'] = {
		...
		body="Wayfarer Robe",hands="Otronif Gloves +1",ring1="Acumen Ring",ring2="Demon's Ring",
	...
	sets.idle.Town = {ammo="Thew Bomblet",
		...
		back="Atheling Mantle",waist="Black Belt",legs="Hesychast's Hose +1",feet="Hermes' Sandals"}
	...
	sets.defense.MDT = {ammo="Demonry Stone",
		head="Uk'uxkaj Cap",neck="Twilight Torque",
		body="Otronif Harness +1",hands="Anchorite's Gloves",ring1="Defending Ring",ring2="Shadow Ring",
	...
	sets.engaged.Mod = {ammo="Thew Bomblet",
		head="Felistris Mask",neck="Asperity Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
		body="Qaaxo Harness",hands="Anchorite's Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
		back="Atheling Mantle",waist="Windbuffet Belt",legs="Hesychast's Hose +1",feet="Anchorite's Gaiters +1"}
	...
	sets.engaged.PDT = {ammo="Thew Bomblet",
		...
		back="Iximulew Cape",waist="Windbuffet Belt",legs="Hesychast's Hose +1",feet="Otronif Boots"}
